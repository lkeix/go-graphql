...
func (ec *executionContext) field_Mutation_createTask_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewTask2githubᚗcomᚋlkeixᚋgraphqlᚑsandboxᚋgraphᚋmodelᚐNewTask(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createTask(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTask2ᚖgithubᚗcomᚋlkeixᚋgraphqlᚑsandboxᚋgraphᚋmodelᚐTask(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewTask2githubᚗcomᚋlkeixᚋgraphqlᚑsandboxᚋgraphᚋmodelᚐNewTask(ctx context.Context, v interface{}) (model.NewTask, error) {
...
func (ec *executionContext) marshalNTask2githubᚗcomᚋlkeixᚋgraphqlᚑsandboxᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v model.Task) graphql.Marshaler {
	return ec._Task(ctx, sel, &v)
}

func (ec *executionContext) marshalNTask2ᚖgithubᚗcomᚋlkeixᚋgraphqlᚑsandboxᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v *model.Task) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
